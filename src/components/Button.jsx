function Button({ type = null, onClick, disabled = false }) {
  ...
  const typeClasses = {
    ...
    next: "w-[360px] bg-[#E46F50] text-white text-[26px] max-[900px]:text-[23px] leading-[36px] hover:bg-[#F1B287] focus:bg-[#E46F50] disabled:bg-[#f0cac0] disabled:cursor-default",
